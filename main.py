...
class Record:
    ...
    def add_birthday(self, birthday):
        self.birthday = Birthday(birthday)  # додаємо день народження
    ...
    def days_to_birthday(self):
        ...
        return (next_birthday - today).days  # к-сть днів до дня народження
...
class AddressBook(UserDict):
    ...
    def get_upcoming_birthdays(self, days=7):
        ...
        return birthdays_next_week  # повертаємо список майбутніх днів народження
